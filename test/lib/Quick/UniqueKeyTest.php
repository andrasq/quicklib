...
class Quick_UniqueKeyTest
    extends Quick_Test_Case
{
    public function setUp( ) {
        $this->_cut = new Quick_UniqueKey();
    }
    ...
    public function xx_NewtestSpeed( ) {
        $cut = $this->_cut;
        ...
        echo $timer->timeit(10000, "(string)new", array($this, '_testSpeedNew'), array($cut));
    ...
    public function _testSpeedNew( $cut ) {
        (string)(new Quick_Uniquekey());
    }

    public function _testSpeedCreate( $cut ) {
        Quick_UniqueKey::createKey();
    }
}
